...
Txt.editPixelByPixel = "<strong>miniature</strong><i>.png</i> と呼ばれるファイルがダウンロードされます。編集ツールを利用しステッカー単位でピクセルを変更できますので、その後、<a href='./ALGmoz0.html'>ALG変換</a> というページを開き、アップロードしてください。(そこへ drag-and-drop または、\"Drop miniature.png here\" をクリック)";
